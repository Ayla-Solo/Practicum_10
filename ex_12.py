...
# Создаём экран для рисования
screen = t.Screen()
# Устанавливаем размер окна 800x600 пикселей
screen.setup(width=800, height=600)
# Устанавливаем максимальную скорость рисования
t.speed(0)
# Прячем черепашку (курсор), чтобы не мешал
t.hideturtle()
